...
pub const CLOSE_ID: &str = "x";

pub const INDEX: &[&str] = &[
    "locks", "ai", "imf", "filter", "usr", "adm", "sec", "msg", "tm", "ls", "cl", "st", "gr",
    "lim", "wc", "an", "cp", "wn", "jn", "ad", "ng", "sl", "bl", "lg", "nsw", "cq", "tmed", "vw",
    "etc",
];
...
pub const TOPICS: &[Topic] = &[
    Topic {
        ...
        commands: &[
            ...
            cmd("قفل گروه 2 ساعت", "می بندد و خودش باز می کند"),
            ...
            cmd("قفل کامنت", "کامنت زیر پست های کانال را می بندد"),
        ],
        examples: &[
            eg(
                "قفل عکس",
                "از این به بعد هر عکسی که فرستاده شود پاک می شود.",
            ),
        ...
        notes: &[
            ...
            "«قفل دستورات» جلوی دستورهای عمومی ربات را می گیرد — پینگ، راهنما، قوانین، گزارش، لیست ادمین، اطلاعات و «قفل ها». باقی دستورها از قبل فقط برای ادمین بودند. ادمین ها و کاربران ویژه معاف اند.",
            "این یکی برخلاف بقیه قفل ها پیام را پاک نمی کند؛ فقط ربات جواب نمی دهد. کسی که «پینگ» فرستاده کار خلافی نکرده، چیزی خواسته که اجازه اش را ندارد، و پاک کردن پیامش تنبیه برای یک سوال است.",
            "«قفل کامنت» فقط برای گروهی معنا دارد که به یک کانال وصل است. با روشن بودنش، زیر هر پست تازه کانال یک پیام گذاشته می شود و بعد از آن هر کامنتی پاک می گردد. گفتگوی عادی گروه دست نخورده می ماند و ادمین ها مثل هر قفل دیگری معاف اند.",
            "زیر پست های قدیمی تر آن پیام گذاشته نمی شود، ولی کامنت هایشان هم پاک می شود.",
        ],
    },
    Topic {
        id: "usr",
        ...
        commands: &[
            ...
            cmd(
                "تنظیم دستور زنجیر بن",
                "یک کلمه یا عبارت دلخواه برای بن، کیک یا سکوت می سازد",
            ),
            cmd("حذف دستور زنجیر", "آن دستور سفارشی را بر می دارد"),
        ],
        examples: &[
            eg(
                "سکوت 10 دقیقه",
                "روی پیام کاربر ریپلای کنید. ده دقیقه ساکت می شود.",
            ),
            eg(
                "بن @ali 1 روز",
                "علی یک روز اخراج می شود و بعد خودش می تواند برگردد.",
            ),
            eg("حذف بن", "روی پیام یا با آیدی عددی، بن برداشته می شود."),
            eg(
                "تنظیم دستور زنجیر بن",
                "از این به بعد «زنجیر @ali» هم مثل «بن @ali» عمل می کند.",
            ),
            eg(
                "تنظیم دستور بیرونش کن کیک",
                "عبارت چند کلمه ای هم می شود؛ «بیرونش کن @ali» او را اخراج می کند.",
            ),
        ],
        extra: None,
        notes: &[
            ...
            "«پاکسازی پیام ها با بن» و «پاکسازی پیام ها با سکوت» در پنل › امنیت و ورود، جدا از هم: هر کدام روشن باشد، همان نوع محدودیت پیام های آن کاربر را هم پاک می کند. این کار برگشت پذیر نیست و شامل سکوت و بن خودکار (ضد رگبار، سقف اخطار، حالت سختگیرانه، ضد هجوم و احراز هویت) هم می شود.",
            "ربات خودش فقط پیام هایی را می تواند پاک کند که از وقتی این گزینه روشن شده دیده است. اگر کلینر در گروه باشد، کل تاریخچه آن کاربر پاک می شود؛ تلگرام پاک کردن تاریخچه را فقط به اکانت کاربری می دهد، نه به ربات.",
            "کیک فقط عضو را اخراج می کند و او بلافاصله می تواند برگردد؛ برخلاف بن و سکوت، هیچ کلمه آماده ای ندارد و فقط با یک دستور سفارشی در دسترس می شود.",
            "هر گروه حداکثر ۲۰ دستور سفارشی می تواند بسازد، هر کدام تا ۴ کلمه؛ لیستشان در «لیست دستور».",
        ],
    },
    Topic {
        id: "adm",
        ...
        commands: &[
            cmd(
                "افزودن ادمین",
                "ادمین تلگرام با انتخاب دسترسی ها روی صفحه شیشه ای",
            ),
            ...
            cmd(
                "تنظیم تگ مدیر ارشد",
                "مقام نمایشی کاربر در تلگرام، تا ۱۶ حرف",
            ),
            ...
            cmd("وضعیت نصب", "دسترسی های ربات و آنچه هنوز کم است"),
        ],
        examples: &[
            eg(
                "ترفیع @ali",
                "علی ادمین ربات می شود؛ از قفل ها معاف است ولی دسترسی تلگرامش عوض نمی شود.",
            ),
            eg(
                "تنظیم تگ مدیر ارشد",
                "روی پیام کاربر ریپلای کنید. مقامش در تلگرام «مدیر ارشد» می شود، چه ادمین باشد چه عضو عادی.",
            ),
        ],
        extra: None,
        notes: &[
            ...
            "ربات تا وقتی همه دسترسی های لازم را نداشته باشد فعال نمی شود و «کانفیگ» هم کار نمی کند. «وضعیت نصب» می گوید کدام دسترسی کم است.",
            "«افزودن ادمین جدید» را حتما بدهید: کلینر بدون آن ادمین نمی شود، و به محض دادنش خودکار به گروه می آید.",
        ],
    },
    Topic {
        id: "sec",
        ...
        commands: &[
            ...
            cmd(
                "تنظیم خیانت 5 10",
                "ادمینی که ۵ نفر را در ۱۰ دقیقه حذف کند، عزل می شود",
            ),
            cmd("تنظیم احراز 120", "مهلت احراز هویت عضو تازه، به ثانیه"),
            cmd("تنظیم اخطار 5", "سقف اخطار"),
            cmd(
                "تنظیم عضویت اجباری @channel",
                "تا عضو کانال نشود پیامش پاک می شود",
            ),
            ...
            cmd(
                "تنظیم اعلان شرط 120 30",
                "فاصله اعلان شرط و حذف خودکارش، به ثانیه",
            ),
            cmd("لینک", "لینک دعوت فعلی گروه"),
            cmd("لینک جدید", "لینک قبلی را باطل و یکی تازه می سازد"),
        ...
        examples: &[
            eg(
                "ضد رگبار 10 5",
                "هر کس بیش از ده پیام در پنج ثانیه بفرستد سکوت می شود.",
            ),
            eg(
                "تنظیم عضویت اجباری @mychannel",
                "تا عضو کانال نشود، پیامش پاک می شود.",
            ),
        ],
        extra: None,
    ...
    Topic {
        ...
        commands: &[
            ...
            cmd(
                "تنظیم خوشامد سلام {نام}",
                "خوشامد را از متن بعد از دستور می گیرد",
            ),
            ...
            cmd(
                "تنظیم اعلان 15",
                "اعلان حذف پس از ۱۵ ثانیه پاک شود؛ صفر یعنی هرگز",
            ),
        ],
        examples: &[
            eg(
                "تنظیم خوشامد سلام {نام} به {گروه} خوش آمدی",
                "هر عضو تازه این را با نام خودش می گیرد.",
            ),
            eg(
                "تنظیم پاسخ سلام = درود بر شما",
                "هر کس «سلام» بنویسد، «درود بر شما» می گیرد.",
            ),
        ],
        extra: None,
        notes: &[
    ...
    Topic {
        ...
        examples: &[
            eg(
                "قفل شب 23 تا 7",
                "هر شب ساعت ۲۳ گروه بسته و ۷ صبح باز می شود.",
            ),
    ...
    Topic {
        ...
        commands: &[
            ...
            cmd("لیست فیلتر تصویری", "فیلترهای تصویری این گروه"),
            cmd("لیست پاسخ", "پاسخ های خودکار"),
            cmd("لیست معاف", "معاف های شرط ورود"),
            cmd("لیست دستور", "دستورهای سفارشی این گروه برای بن، کیک و سکوت"),
            cmd("لیست پک", "پک های استیکر قفل شده"),
            cmd("لیست", "بازکردن منوی همه لیست ها"),
            cmd("لیست ها", "همان منوی همه لیست ها"),
            cmd("لیست لیست ها", "همان منوی همه لیست ها"),
            cmd("پاکسازی لیست بن", "کل آن لیست را خالی می کند"),
            cmd("پاکسازی لیست پک", "همه پک های قفل شده را باز می کند"),
        ],
        examples: &[],
        extra: None,
    ...
    Topic {
        ...
        commands: &[
            ...
            cmd("فیلتر دقیق", "کلمه فقط جدا شمرده شود، نه داخل کلمه دیگر"),
            cmd("فیلتر عادی", "برگشت به حالت معمول"),
        ],
        examples: &[
            eg(
                "افزودن فیلتر تبلیغ",
                "هر پیامی که «تبلیغ» داشته باشد پاک می شود.",
            ),
            eg("حذف فیلتر تبلیغ", "آن کلمه از لیست بر می گردد."),
            eg(
                "فیلتر دقیق",
                "اگر «بت» در لیست باشد، «صحبت» دیگر اشتباهی پاک نمی شود.",
            ),
        ],
        extra: None,
        notes: &[
            ...
            "در حالت دقیق، کلمه فقط وقتی می گیرد که خودش جدا آمده باشد؛ در عوض «فروش» دیگر «فروشی» را نمی گیرد. برای شناختن پیام های فروش، «قفل خرید و فروش» هست که معنا را می فهمد.",
        ],
    },
    Topic {
        id: "cl",
        ...
        examples: &[
            ...
            eg(
                "حذف پیام",
                "روی پیام کاربر ریپلای کنید. همه پیام هایش در گروه پاک می شود.",
            ),
        ],
        extra: None,
        notes: &[
    ...
    Topic {
        ...
        commands: &[
            ...
            cmd(
                "مقام",
                "کارنامه مقام کاربر: سطح، نوار پیشرفت و فاصله تا مقام بعدی",
            ),
            cmd("مقام @ali", "همان کارنامه با یوزرنیم یا آیدی عددی"),
        ...
        examples: &[
            eg(
                "امار",
                "داشبورد گروه با برترین ها، ساعت های شلوغ و نوع پیام ها.",
            ),
            eg("اطلاعات", "روی پیام کاربر ریپلای کنید تا کارتش را ببینید."),
            eg(
                "مقام",
                "روی پیام کاربر ریپلای کنید تا مقام و سطحش را ببینید. «رتبه»، «سطح»، «لول» و «مدال» هم همین کار را می کنند.",
            ),
        ],
        extra: None,
        notes: &[
            "«امار»، «اطلاعات» و «مقام» را همه می توانند بفرستند.",
            "مقام خودکار ۱۶ پله دارد، از ۵۰ پیام («سلام گو») تا ۱۰۰۰۰۰ پیام («جاودانه»)، و از پنل روشن می شود.",
            "با روشن بودنش، مقام کنار نام کاربر در گروه هم نوشته می شود، بدون اینکه کسی ادمین شود. برای این کار ربات باید ادمین باشد و اجازه «مدیریت مقام ها» داشته باشد.",
            "برای برداشتن مقام یک نفر، روی پیامش «حذف مقام» بفرستید.",
        ],
    },
    Topic {
        id: "gr",
        ...
        examples: &[eg(
            "اختیار عکس بسته",
            "اعضای عادی دیگر عکس نمی فرستند؛ ادمین ها می فرستند.",
        )],
    ...
    Topic {
        ...
        notes: &[
            "این بخش دستور متنی ندارد و فقط از پنل تنظیم می شود.",
            "در «موارد تخلف» انتخاب می کنید کدام قفل ها تخلف حساب شوند — قفل های نگهبان هوشمند مثل خرید و فروش و غیراخلاقی هم همین جا هستند.",
            "تعداد اخطار، سکوت یا بن، و مدت سکوت (از پنج دقیقه تا دائمی) همه از همین صفحه قابل تنظیم اند.",
    ...
    Topic {
        ...
        examples: &[eg(
            "ضد رگبار 10 5",
            "بیش از ده پیام در پنج ثانیه یعنی سکوت یا بن.",
        )],
        extra: None,
    ...
    Topic {
        ...
        commands: &[
            cmd("احراز هویت روشن", "احراز هویت را روشن می کند"),
            cmd("احراز هویت خاموش", "خاموشش می کند"),
            cmd("تنظیم احراز 120", "مهلت پاسخ، به ثانیه"),
        ],
        examples: &[],
        extra: None,
        notes: &[
            "«احراز روشن» و «احراز خاموش» هم همان کار را می کنند.",
            "پس از پایان مهلت یا سکوت می ماند یا اخراج می شود؛ انتخابش در همین صفحه است.",
        ],
    },
    Topic {
        id: "wn",
    ...
    Topic {
        ...
        examples: &[eg(
            "تنظیم عضویت اجباری @mychannel",
            "تا عضو نشود پیامش پاک می شود و دکمه عضویت می گیرد.",
        )],
        extra: None,
    ...
    Topic {
        ...
        examples: &[eg(
            "تنظیم اد اجباری 5",
            "تا پنج نفر اضافه نکند اجازه نوشتن ندارد.",
        )],
        extra: None,
    ...
    Topic {
        ...
        commands: &[cmd(
            "تنظیم اعلان شرط 120 30",
            "هر ۱۲۰ ثانیه یک بار، حذف پس از ۳۰ ثانیه",
        )],
        examples: &[],
        extra: None,
    ...
    Topic {
        ...
        examples: &[eg(
            "تنظیم پاسخ قیمت = لیست قیمت در کانال است",
            "هر کس «قیمت» بنویسد این را می گیرد.",
        )],
        extra: None,
        notes: &[
    ...
    Topic {
        ...
        examples: &[eg(
            "تنظیم خوشامد سلام {نام}",
            "هر عضو تازه با نام خودش خوشامد می گیرد.",
        )],
        extra: None,
        notes: &[
            "تگ ها: {نام} · {منشن} · {آیدی} · {یوزرنیم} · {گروه}",
            "«خوشامد» به تنهایی متن نمی گیرد، چون «خوشامد گفتم» یک جمله است.",
            "قالب بندی و ایموجی پرمیوم همان پیامی که ریپلای کرده اید نگه داشته می شود.",
            "حذف خودکار خوشامد از پنل تنظیم می شود.",
            "گروه تازه با یک خوشامد پیش فرض و حذف خودکار ۱۰ ثانیه راه می افتد. هر دو از پنل و با همین دستورها عوض می شوند، و «کانفیگ» دوباره روی خوشامدی که خودتان نوشته اید چیزی نمی نویسد.",
        ],
    },
    Topic {
        id: "ng",
        ...
        examples: &[eg(
            "قفل شب 23:30 تا 7",
            "هر شب ۲۳:۳۰ بسته و ۷ صبح باز می شود.",
        )],
        extra: None,
        notes: &[
            "بستن و باز کردن از راه اختیارات گروه انجام می شود، پس ادمین ها همچنان می نویسند.",
        ],
    },
    Topic {
        id: "sl",
    ...
    Topic {
        ...
        examples: &[eg(
            "قفل بایو",
            "از این به بعد هر کس لینک در بایو داشته باشد پیامش پاک می شود.",
        )],
        extra: None,
        notes: &[
    ...
    Topic {
        ...
        commands: &[
            cmd("پنل", "بخش «نگهبان هوشمند» را از منو باز کنید"),
            cmd(
                "قفل غیراخلاقی",
                "همه اینها اسم هم دارند و با دستور هم روشن می شوند",
            ),
            cmd("قفل سیگار", "یکی از موضوع ها"),
            cmd("قفل تبلیغ در تصویر", "متن روی عکس را می خواند"),
            cmd(
                "قفل خرید و فروش",
                "پیام فروش و آگهی را از معنایش می شناسد، نه از کلمه هایش",
            ),
        ],
        examples: &[
            eg(
                "پنل",
                "منو باز می شود؛ «نگهبان هوشمند» همه را یک جا نشان می دهد و با یک تپ روشن و خاموش می شوند.",
            ),
            eg(
                "قفل خرید و فروش",
                "«گوشی فروشی، ۲۰ میلیون» پاک می شود؛ «دیروز یه گوشی خریدم» می ماند، چون فروش نیست.",
            ),
        ],
        extra: None,
        notes: &[
            "هر تصویر یک بار گرفته و باز می شود، هر چند مورد که روشن باشد. روشن کردن مورد ششم تقریبا هزینه ای روی مورد اول اضافه نمی کند.",
            "نتیجه برای هر فایل و هر متن نگه داشته می شود، پس همان تصویر یا همان آگهی که دوباره یا در گروه دیگری فرستاده شود، دوباره بررسی نمی شود.",
            "تا وقتی هیچ کدام روشن نشده اند، هیچ چیزی دانلود یا بررسی نمی شود.",
            "حساسیت خرید و فروش و حالت «فقط بررسی، بدون حذف» آن در «تنظیم موضوعی» است.",
            "با «برخورد با تکرار تخلف» تعیین می کنید متخلف تکراری چه شود: چند اخطار، بعد سکوت (با مدت دلخواه یا دائمی) یا بن.",
            "«قفل همه» اینها را روشن نمی کند. عمدی است — کسی که همه قفل ها را می خواهد، منظورش روشن کردن چند مدل نیست.",
            "ادمین ها و کاربران ویژه مثل بقیه قفل ها معاف اند.",
        ],
    },
    Topic {
        ...
        examples: &[eg(
            "قفل غیراخلاقی",
            "از این به بعد تصویرهای مستهجن پاک می شوند.",
        )],
        extra: None,
        notes: &[
            "این قفل یک کلید روشن و خاموش دارد؛ امتیاز، حالت آزمایشی و برچسب لازم نیست.",
            "مدل دوم و مدل عمومی برای کم کردن خطای عکس های معمولی در تصمیم دخالت می کنند.",
            "سه مدل پشت این قفل اند و سومی حق وتو دارد: یک مدل عمومی که کل تصویر را می فهمد. هر چقدر هم دو تای اول مطمئن باشند، اگر این یکی تصویر را عکس معمولی بداند پاک نمی شود. عکس پرتره و عکس آدم با شانه باز، همان هایی که بیشترین اشتباه را می ساختند، این طور نگه داشته می شوند.",
    ...
    Topic {
        ...
        commands: &[
            cmd("قفل سیگار", "یکی از موضوع ها را روشن می کند"),
            cmd("بازکردن سیگار", "همان را بر می دارد"),
        ],
        examples: &[eg(
            "قفل سیگار",
            "از این به بعد تصویرهایی که سیگار در آنها تشخیص داده شود پاک می شوند.",
        )],
        extra: None,
        notes: &[
            "دقتش از قفل غیراخلاقی کمتر است. قفل که روشن شود پاک هم می کند؛ اگر می خواهید اول فقط نتیجه را در لاگ ببینید، «فقط بررسی، بدون حذف» را از همین صفحه روشن کنید.",
            "روشن کردن چند موضوع با هم هیچ هزینه اضافه ای ندارد: تصویر یک بار بررسی می شود و بقیه فقط یک مقایسه ساده اند.",
            "«حساسیت» را از همین صفحه کم و زیاد کنید. عدد کمتر یعنی سخت گیرتر و اشتباه بیشتر.",
            "«قفل تبلیغ در تصویر» فرق دارد: متنی که روی خود تصویر نوشته شده را می خواند و اگر لینک تلگرام یا آیدی کانال داشت پاک می کند. همان چیزی که قفل لینک روی متن پیام می گیرد، این بار روی پیکسل ها.",
            "خواندن متن فقط لاتین است — t.me و آیدی و آدرس سایت. متن فارسی روی تصویر خوانده نمی شود.",
            "ادمین ها و کاربران ویژه مثل بقیه قفل ها معاف اند.",
        ],
    },
    Topic {
        ...
        commands: &[
            cmd(
                "قفل تصویر اسب",
                "فیلتر آماده و فعال، بدون واسنجی یا دستور اضافه",
            ),
            cmd("فیلتر متنی خودرو لوکس", "از روی عبارت، بدون نمونه"),
            cmd("فیلتر این ورزشی", "با ریپلای روی عکس، نمونه اضافه می کند"),
            cmd("حذف فیلتر تصویری ورزشی", "فیلتر را بر می دارد"),
            cmd("لیست فیلتر تصویری", "همه فیلترها، با حذف تکی"),
        ],
        examples: &[
            eg(
                "قفل تصویر اسب",
                "همان لحظه فیلتر فعال می شود و تصویرهای مربوط به اسب را پاک می کند.",
            ),
            eg(
                "فیلتر این ورزشی",
                "روی عکس ریپلای کنید. هر عکس شبیه آن گرفته می شود.",
            ),
        ],
        extra: None,
        notes: &[
            "همه فیلترها همان لحظه فعال اند؛ امتیاز، کالیبراسیون و برچسب لازم نیست.",
            "هر گروه تا ۸ فیلتر، و هر فیلتر تا ۸ نمونه برای دقیق تر شدن نمونه تصویری.",
            "فیلتر متنی به مدل متنی روی سرور نیاز دارد. اگر نصب نباشد فقط راه نمونه کار می کند.",
            "ادمین ها و کاربران ویژه مثل بقیه قفل ها معاف اند.",
        ],
    },
    Topic {
        ...
        commands: &[
            ...
            cmd("تنظیم یادداشت ‹متن›", "با ریپلای، یادداشت را می نویسد"),
            ...
            cmd("تگ همه", "همه اعضا را دسته دسته صدا می زند"),
            cmd("تگ 30", "همان کار، ۳۰ نفر در هر پیام"),
            cmd("توقف", "تگ در حال اجرا را می ایستاند"),
        ],
        examples: &[
            eg("تگ", "همه اعضا صدا زده می شوند، ۶ نفر در هر پیام."),
        ...
        notes: &[
            ...
            "«یادداشت» فقط نشان می دهد؛ برای نوشتن «تنظیم یادداشت» را ببرید، چون یک کلمه به تنهایی نمی تواند متن بگیرد.",
            "عدد تگ یعنی چند نفر در هر پیام، نه چند نفر در کل؛ بدون عدد ۶ نفر. تگ تا آخر گروه ادامه دارد.",
            "برای تگ با یک متن، روی همان پیام ریپلای کنید و «تگ» بفرستید.",
            "«توقف» و «استاپ» تگ را می ایستانند و فقط دست ادمین اند؛ وقتی تگی در کار نباشد جوابی هم ندارند.",
        ],
    },
    Topic {
        id: "vw",
        ...
        commands: &[
            cmd("فیلتر ویس کلمه ‹کلمه›", "کلمه را به فهرست اضافه می کند"),
            cmd("حذف کلمه ویس ‹کلمه›", "کلمه را بر می دارد"),
            cmd("لیست کلمات ویس", "فهرست فعلی"),
        ],
        examples: &[eg(
            "فیلتر ویس کلمه فحش",
            "هر ویسی که این کلمه در آن باشد حذف می شود.",
        )],
        extra: None,
        notes: &[
            "روشن و خاموش کردنش در پنل › امنیت و ورود است.",
            "کلمه ای که از پیش آماده بوده با حذف شدن خاموش می شود و از همان صفحه بر می گردد.",
        ],
    },
];
...
fn lock_names() -> String {
    const GROUPS: &[(&str, &[&str])] = &[
        ...
        (
            "تعاملی",
            &["poll", "dice", "contact", "location", "button", "story"],
        ),
        ("هویت", &["anon", "bot", "promoter", "biolink"]),
        ("رویداد", &["edit", "pin", "service", "comment"]),
    ];
...
static RENDERED: std::sync::LazyLock<Vec<(&'static str, String)>> =
    std::sync::LazyLock::new(|| TOPICS.iter().map(|topic| (topic.id, page(topic))).collect());
...
mod tests {
    ...
    fn alias_groups() -> Vec<(&'static str, Vec<&'static str>)> {
        ...
        vec![
            ...
            owned("imgfilter::TEXT_ADD", super::super::imgfilter::TEXT_ADD),
            owned("imgfilter::PHOTO_ADD", super::super::imgfilter::PHOTO_ADD),
            owned("imgfilter::SAMPLE_ADD", super::super::imgfilter::SAMPLE_ADD),
            owned("imgfilter::REMOVE", super::super::imgfilter::REMOVE),
            owned("filters::ADD", super::super::filters::ADD),
            owned("filters::REMOVE", super::super::filters::REMOVE),
            owned("filters::EXACT_ON", super::super::filters::EXACT_ON),
            owned("filters::EXACT_OFF", super::super::filters::EXACT_OFF),
            ...
            owned("captcha::NAMES", super::super::captcha::NAMES),
            owned(
                "voicemonitor::ADD_COMMANDS",
                super::super::voicemonitor::ADD_COMMANDS,
            ),
            owned(
                "voicemonitor::REMOVE_COMMANDS",
                super::super::voicemonitor::REMOVE_COMMANDS,
            ),
            owned(
                "voicemonitor::LIST_COMMANDS",
                super::super::voicemonitor::LIST_COMMANDS,
            ),
            owned("extras::NOTE_SET", super::super::extras::NOTE_SET),
            owned("invite::COMMANDS", super::super::invite::COMMANDS),
            owned("invite::RENEW", super::super::invite::RENEW),
            ...
            owned("install::STATUS", super::super::install::STATUS),
            ...
            owned("extras::TAG_STOP", super::super::extras::TAG_STOP),
            ...
            owned("stats::RANK", super::super::stats::RANK),
            owned("tune::COMMANDS", super::super::tune::COMMANDS),
            owned("restrict::CUSTOM_SET", super::super::restrict::CUSTOM_SET),
            owned(
                "restrict::CUSTOM_REMOVE",
                super::super::restrict::CUSTOM_REMOVE,
            ),
        ]
    }
    ...
    #[test]
    fn no_alias_belongs_to_two_tables() {
        const SHARED_BY_DISJOINT_TAILS: &[&str] = &["پاکسازی"];

        let mut seen: Vec<(&str, &str)> = Vec::new();
        for (table, aliases) in alias_groups() {
            for alias in aliases {
                if SHARED_BY_DISJOINT_TAILS.contains(&alias) {
                    continue;
                }
                if let Some((owner, _)) = seen.iter().find(|(_, taken)| *taken == alias) {
                    panic!("«{alias}» is in both {owner} and {table}");
                }
                seen.push((table, alias));
            }
        }
    }
    ...
    fn every_topic_is_reachable_and_named_once() {
        ...
        for id in INDEX {
            assert!(
                find(id).is_some(),
                "the index offers «{id}», which has no topic"
            );
        }
    }
    ...
    fn every_panel_section_has_a_topic() {
        ...
        for page in super::super::panel::PAGES {
            ...
            assert!(
                find(page).is_some(),
                "panel section «{page}» has no help topic, so its page carries no راهنما"
            );
        }
    }
    ...
    fn every_topic_can_be_reached() {
        for topic in TOPICS {
            let reachable = INDEX.contains(&topic.id) || super::super::panel::is_page(topic.id);
            assert!(
                reachable,
    ...
    #[test]
    fn the_models_are_documented_in_their_own_section() {
        let section = TOPICS
            .iter()
            .find(|topic| topic.id == "ai")
            .expect("the نگهبان تصویر topic must exist");
        let page = lock_names();
        for lock in locks::LOCKS.iter().filter(|lock| locks::is_ai(lock.key)) {
            assert!(
                !page.contains(lock.names[0]),
                "«{}» is a model and should have left the locks reference",
                lock.names[0]
            );
        }
        ...
        for id in ["ai", "nsw", "cq"] {
            assert!(
                ...
                "«{id}» must be a topic — the section links to it"
            );
        }
        assert!(
            INDEX.contains(&section.id),
            "the section must be on the index"
        );
    }
}
