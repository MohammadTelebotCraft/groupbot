...
pub const INDEX: &[&str] = &[
    "locks", "ai", "filter", "usr", "adm", "sec", "msg", "tm", "ls", "cl", "st", "gr",
    "lim", "etc",
];
...
pub const TOPICS: &[Topic] = &[
    Topic {
        ...
        notes: &[
            ...
            "«قفل دستورات» جلوی دستورهای عمومی ربات را می گیرد — پینگ، راهنما، قوانین، گزارش، لیست ادمین، اطلاعات و «قفل ها» — و همچنین هر پیامی که با / شروع شود. باقی دستورها از قبل فقط برای ادمین بودند. ادمین ها و کاربران ویژه معاف اند.",
        ],
    },
    Topic {
        id: "usr",
    ...
    Topic {
        ...
        icon: "🤖",
        title: "نگهبان تصویر",
        intro: "هر چیزی که به جای نوع پیام، به خود تصویر نگاه می کند: محتوای غیراخلاقی، شش موضوع مشخص، و تبلیغی که به جای متن پیام روی خود عکس نوشته شده. اینها با قفل های معمولی یک جا نیستند چون فرق دارند — قفل معمولی از روی خود پیام تصمیم می گیرد و مجانی است، اینها تصویر را می گیرند و به مدل می دهند.",
        commands: &[
            cmd("پنل", "بخش «نگهبان تصویر» را از منو باز کنید"),
            cmd("قفل غیراخلاقی", "همه اینها اسم هم دارند و با دستور هم روشن می شوند"),
            cmd("قفل سیگار", "یکی از موضوع ها"),
            cmd("قفل تبلیغ در تصویر", "متن روی عکس را می خواند"),
        ],
        examples: &[
            eg("پنل", "منو باز می شود؛ «نگهبان تصویر» همه را یک جا نشان می دهد و با یک تپ روشن و خاموش می شوند."),
        ],
        extra: None,
        notes: &[
            ...
            "نتیجه برای هر فایل نگه داشته می شود، پس همان تصویر که دوباره یا در گروه دیگری فرستاده شود، دوباره بررسی نمی شود.",
            "تا وقتی هیچ کدام روشن نشده اند، هیچ تصویری دانلود نمی شود.",
            "«قفل همه» اینها را روشن نمی کند. عمدی است — کسی که همه قفل ها را می خواهد، منظورش روشن کردن شش مدل نیست.",
            "ادمین ها و کاربران ویژه مثل بقیه قفل ها معاف اند.",
        ],
    },
    Topic {
        ...
        notes: &[
            ...
            "«حساسیت» از همین پنل تنظیم می شود. عدد بالاتر یعنی سخت گیری کمتر و اشتباه کمتر.",
            "به صورت پیش فرض هر چیزی که مدل تشخیص بدهد پاک می شود، از جمله چیزی که صرفا محرک است مثل لباس شنا. اگر می خواهید این دسته بماند و فقط مستهجن پاک شود، «نگه داشتن محتوای محرک» را از همین صفحه روشن کنید.",
    ...
    Topic {
        ...
        icon: "🚭",
        title: "قفل موضوعی",
        intro: "چند موضوع مشخص را در تصویرها می گیرد — سیگار، مشروب، اسلحه، قمار، مواد و خون. مثل قفل غیراخلاقی به خود تصویر نگاه می کند، ولی به جای یک مدل آموزش دیده برای همان کار، از یک مدل عمومی استفاده می کند.",
        commands: &[
            cmd("قفل سیگار", "یکی از موضوع ها را روشن می کند"),
            cmd("بازکردن سیگار", "همان را بر می دارد"),
        ],
        examples: &[
            eg("قفل سیگار", "از این به بعد تصویرهایی که سیگار در آنها تشخیص داده شود پاک می شوند."),
        ],
        extra: None,
        notes: &[
...
mod tests {
    ...
    fn the_models_are_documented_in_their_own_section() {
        ...
        assert!(INDEX.contains(&section.id), "the section must be on the index");
    }
}
