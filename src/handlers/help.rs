...
pub const TOPICS: &[Topic] = &[
    ...
    Topic {
        ...
        commands: &[
            cmd("قفل بایو", "قفل را روشن می کند"),
            cmd("بازکردن بایو", "قفل را بر می دارد"),
        ],
        examples: &[
            eg("قفل بایو", "از این به بعد هر کس لینک در بایو داشته باشد پیامش پاک می شود."),
        ],
        extra: None,
        notes: &[
            "کاری که با متخلف می شود از همین صفحه انتخاب می شود: فقط حذف، سکوت، اخراج یا بن.",
            "بایوی هر کاربر یک بار خوانده و ده دقیقه به خاطر سپرده می شود، پس اولین پیام هر کس رد می شود و از پیام بعدی گرفته می شود.",
            "ادمین ها و کاربران ویژه مثل بقیه قفل ها معاف اند.",
            "«رفع سکوت» یا «حذف بن» حافظه بایوی آن کاربر را هم پاک می کند.",
        ],
    },
    Topic {
        id: "etc",
...
fn lock_names() -> String {
    const GROUPS: &[(&str, &[&str])] = &[
        ...
        ("هویت", &["anon", "bot", "promoter", "biolink"]),
